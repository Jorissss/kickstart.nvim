...
local lazypath = vim.fn.stdpath 'data' .. '/lazy/lazy.nvim' -- C:\Users\joris\AppData\Local\nvim-data
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- vim.keymap.set('v', '<leader>sc', builtin.git_bcommits_range, { desc = '[S]earch [C]ommits' })
